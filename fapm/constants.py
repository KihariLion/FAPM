...
Optional Arguments:
  ...
  -g AGENT            Specify a custom HTTP User-Agent string.
...
RE_MODERN_TIMESTAMP = _re.compile(r'<div class="section-header">.*? class="popup_date".*?>(.+?)</span>', _re.DOTALL)
RE_MODERN_SENDER = _re.compile(r'<div class="section-header">.*?<span class="js-displayName">(.+?)</span>', _re.DOTALL)
RE_MODERN_RECEIVER = _re.compile(r'<div class="section-header">.*?<span class="js-displayName">.*?<span class="js-displayName">(.+?)</span>', _re.DOTALL)
...
RE_CLASSIC_SENDER = _re.compile(r'<a href="/msg/compose/">.*?<span class="js-displayName">(.+?)</span>', _re.DOTALL)
RE_CLASSIC_RECEIVER = _re.compile(r'<a href="/msg/compose/">.*?<span class="js-displayName">.*?<span class="js-displayName">(.+?)</span>', _re.DOTALL)

...
RE_CLASSIC_SENDER = _re.compile(r'<a href="/msg/compose/">.*?<a .*?<a .*?><strong>(.+?)</strong>', _re.DOTALL)
RE_CLASSIC_RECEIVER = _re.compile(r'<a href="/msg/compose/">.*?<a .*?<a .*?<a .*?><strong>(.+?)</strong>', _re.DOTALL)
